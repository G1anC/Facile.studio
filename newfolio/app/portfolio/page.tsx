        ...
        <div className="bg-[#CAE6D8] sm:p-4 p-2 w-screen h-screen text-[#1E1E1E] flex flex-col gap-3">
            <div className="w-full overflow-hidden h-full relative rounded-[32px]">
                ...
                <img
                    alt="WORKS"
                    src="/icons/Works.svg"
                    className="absolute -bottom-20 w-full -left-1 scale-102 z-20"
                />

                <div className="my-auto top-1/3 -translate-y-1/2 flex flex-col relative w-full px-32 text-[#CAE6D8] gap-32 z-50">
                    <div className="flex justify-between font-extrabold">
                        NAME
                        <div className="flex items-between justify-between w-[600px]">
                            <div>TYPE</div>
                            <div>TIME (WEEKS)</div>
                        </div>
                    </div>
                        ...
                        {data.map((item, id) => {
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-between flex-shrink-0 justify-between w-[600px]">
                                        <div className="flex-shrink-0">{item.description}</div>
